...
public class Menu
{
  ...
  Menu AddComponent(string text, MenuComponent.ComponentType type = MenuComponent.ComponentType.DISPLAY, string textColor = "")
  {
  ...
  Menu AddEvent(EventType type, System.Action<MenuComponent> actions)
  {
  ...
  Menu AddEvent(System.Action<MenuComponent> actions)
  {
    return AddEvent(EventType.ON_SELECTED, actions);
  }
  Menu AddEventFront(System.Action<MenuComponent> actions)
  {
    _menuComponent_last._onSelected = actions + _menuComponent_last._onSelected;
    return this;
  }

  Menu SetSelectorType(MenuComponent.SelectorType selectorType)
  {
  ...
  Menu AddBackButton(MenuType menuType, string text = "")
  {
